...
iii) I edited the script to make a reproducible simulation of Brownian motion. **This edited script is in question-4-code folder in my forked reproducible-research_homework repo**. 
